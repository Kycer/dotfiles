...
```bash
 # 安装基本软件
pacman -S alsa-utils xf86-video-ati xorg-server xorg-xprop ttf-dejavu wqy-zenhei fcitx-im tar git --needed base-devel feh compton rofi wireless_tools pcmanfm dunstrc gvfs gvfs-mtp rxvt-unicode urxvt-perls lightdm zsh ranger htop lightdm-gtk-greeter chromium
